...
import { Menu, X, Star, Shield, Code, Cloud, GraduationCap, Mail, Phone, MapPin, Palette,
Users, Clock, FileText, DollarSign } from 'lucide-react';
...
Professional Web Development & UX/UI Design by U.S. Army Veterans - Transparent
Pricing, Guaranteed Results, Military-Grade Reliability
</p>
...
Founded and operated by U.S. Army veterans who understand discipline and
excellence
</p>
</div>
<div className="text-center">
...
Professional design advice and mockups for your website project. Perfect for getting
expert guidance before hiring any developer.
</p>
...
<div className="text-muted-foreground">3-step process • Professional mockups •
Design recommendations</div>
</div>
</div>
{/* What You Get */}
...
<p className="text-muted-foreground">
3 custom landing page designs based on your inspiration websites and business
needs
</p>
</Card>
<Card className="p-6 text-center">
...
<div className="md:w-1/4 bg-gradient-to-br from-primary to-secondary p-6
text-white">
<div className="text-center">
...
We analyze your current website and business goals. You'll share 3 websites you
love for style inspiration
...
<Card className="overflow-hidden">
<div className="md:flex">
<div className="md:w-1/4 bg-gradient-to-br from-secondary to-accent p-6
text-white">
<div className="text-center">
...
<p className="text-muted-foreground mb-4">
We present 3 professional landing page mockups based on your inspiration
websites.
...
<div className="md:w-3/4 p-6">
<h3 className="text-xl font-semibold mb-3">Final Recommendations &
Handoff</h3>
<p className="text-muted-foreground mb-4">
We finalize your chosen design direction and provide everything you need to take
to any web developer for implementation.
</p>
<div className="grid md:grid-cols-2 gap-4">
<div>
...
<div className="text-sm text-muted-foreground">90 minutes of professional
consultation</div>
</div>
...
<div className="text-sm text-muted-foreground">60 minutes presenting 3
custom mockups</div>
...
<div className="text-sm text-muted-foreground">45 minutes finalizing
deliverables</div>
</div>
<div className="text-right">
...
<h2 className="text-3xl font-bold mb-4">Why Choose Our UX/UI Design
Consultation?</h2>
<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
Perfect for businesses who want professional design guidance without committing to
full development
</p>
...
<div className="text-sm text-muted-foreground">Get expert UX/UI guidance
from veteran professionals</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
...
<div className="text-sm text-muted-foreground">Take our designs to any
developer you choose</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
...
<div className="text-sm text-muted-foreground">Get professional specs to
compare developer quotes</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
...
<div className="text-sm text-muted-foreground">Transform vague ideas into
concrete visual concepts</div>
</div>
</li>
</ul>
</div>
<div>
<h3 className="text-xl font-semibold mb-4 text-secondary">What Makes Us
Different:</h3>
<ul className="space-y-3">
...
<div className="text-sm text-muted-foreground">Structured process with clear
deliverables and timelines</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-secondary mt-1">•</span>
...
<div className="text-sm text-muted-foreground">$85/hour with detailed time
tracking - no surprises</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-secondary mt-1">•</span>
...
<div className="text-sm text-muted-foreground">Direct access to experienced
veteran professionals</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-secondary mt-1">•</span>
...
<div className="text-sm text-muted-foreground">Pure consultation - no sales
pitch for our development services</div>
</div>
</li>
</ul>
</div>
...
<div className="bg-gradient-to-br from-accent via-accent/90 to-secondary text-white
rounded-lg p-8 md:p-12">
<h2 className="text-3xl font-bold mb-6">Ready to Get Professional Design
Guidance?</h2>

<p className="text-xl mb-8 max-w-2xl mx-auto">
Start with our 3-step UX/UI design consultation and get the professional mockups and
...
<p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
Professional web development with transparent hour-based pricing and military
precision
</p>
<div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg p-6
max-w-2xl mx-auto">
<div className="text-2xl font-bold text-primary mb-2">$85/hour + Professional
Timesheet Documentation</div>
...
<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
Transparent pricing based on actual hours worked, documented with professional
timesheet tracking
</p>
</div>
<div className="grid lg:grid-cols-2 gap-8">
{packages.map((pkg, index) => (
<Card key={index} className={`hover:shadow-lg transition-shadow ${index === 1 ?
...
<p className="text-muted-foreground">
Comprehensive analysis of your requirements, goals, and technical specifications with
realistic hour estimates
</p>
</Card>
<Card className="p-6 text-center">
<div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center
justify-center mx-auto mb-4">
<span className="text-2xl font-bold text-secondary">2</span>
</div>
<h3 className="text-xl font-semibold mb-3">Development & Documentation</h3>
<p className="text-muted-foreground">
Professional development with detailed timesheet tracking and regular progress
updates
</p>
</Card>
<Card className="p-6 text-center">
...
<p className="text-muted-foreground">
Comprehensive testing, client approval, and professional launch with ongoing support
options
</p>
</Card>
</div>
...
<div className="text-sm text-muted-foreground">See exactly what you're paying
for with detailed timesheet documentation</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
...
<div className="text-sm text-muted-foreground">Changes and additions are
clearly tracked and billed fairly</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
...
<div className="text-sm text-muted-foreground">Pay for actual work performed,
not inflated project estimates</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
...
<div className="text-sm text-muted-foreground">Detailed records of all work
performed for your business records</div>
</div>
</li>
</ul>
</div>
...
<div className="text-sm text-muted-foreground">Professional timesheet system
with task-level detail</div>
...
<div className="text-sm text-muted-foreground">Weekly progress reports with
time summaries</div>
</div>
</li>
<li className="flex items-start gap-3">
...
<div className="text-sm text-muted-foreground">Veteran-level commitment to
deadlines and quality</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-secondary mt-1">•</span>
...
<div className="text-sm text-muted-foreground">Work directly with our veteran
...
<p className="text-xl mb-8 max-w-2xl mx-auto">
Experience transparent, professional web development with military precision and
accountability.
</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">
<Button size="lg" variant="secondary" asChild>
...
<div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-lg p-6
max-w-2xl mx-auto">
<div className="text-2xl font-bold text-primary mb-2">$85/hour Setup + Monthly
Maintenance</div>
<div className="text-muted-foreground">Honest pricing for professional hosting
services</div>
</div>
</div>
{/* Hosting Packages */}
...
<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
We handle the technical setup, you focus on your business. Monthly check-ins keep
everything running smoothly.
</p>
</div>
<div className="grid lg:grid-cols-3 gap-8">
{hostingOptions.map((option, index) => (
<Card key={index} className={`hover:shadow-lg transition-shadow ${index === 0 ?
'border-primary border-2 relative' : ''}`}>
{index === 0 && (
<div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
<Badge className="bg-primary text-primary-foreground px-4 py-1">
...
Hosting: ${option.monthlyBreakdown.hosting} + Maintenance:
${option.monthlyBreakdown.maintenance}
</div>
</div>
</CardHeader>
<CardContent>
...
<div>
<h4 className="font-semibold mb-3 text-secondary">Monthly
Maintenance:</h4>
<div className="space-y-2">
...
<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
We're honest about what we can deliver as a veteran-owned business with full-time
...
<p className="text-sm text-muted-foreground">We handle all the technical
complexity upfront so your site runs smoothly</p>
</div>
<div className="text-center">
<div className="w-16 h-16 bg-secondary/10 rounded-full flex items-center
justify-center mx-auto mb-4">
...
<p className="text-sm text-muted-foreground">Once per month we review
performance, handle updates, and fix any issues</p>
</div>
<div className="text-center">
<div className="w-16 h-16 bg-accent/10 rounded-full flex items-center justify-center
mx-auto mb-4">
...
<p className="text-sm text-muted-foreground">We'll tell you exactly what we can
and can't do within our schedule</p>
</div>
</div>
</div>
</section>
...
<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
No fancy promises we can't keep. Here's exactly what you get for your monthly
maintenance fee.
</p>
</div>
<div className="grid md:grid-cols-2 gap-8">
<Card className="p-6">
<h3 className="text-lg font-semibold mb-4 text-primary">Monthly Check-in (1-4
hours)</h3>
<div className="space-y-2">
...
<h2 className="text-3xl font-bold mb-6">Ready for Honest, Professional
Hosting?</h2>
<p className="text-xl mb-8 max-w-2xl mx-auto">
No overselling, no false promises. Just professional hosting setup and realistic monthly
maintenance.
</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">
<Button size="lg" variant="secondary" asChild>
...
<div>
<h2 className="text-3xl font-bold mb-6">Empowering Veterans Through
Technology</h2>
<p className="text-lg text-muted-foreground mb-6">
Our VetTech Academy provides comprehensive technology training specifically
designed for veterans
transitioning to civilian careers. Leveraging VA education benefits, we help fellow
veterans
...
Master the fundamentals of web development with comprehensive HTML and CSS
training
</p>
</Card>
<Card className="p-6 text-center">
...
<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
U.S. Army veterans bringing military discipline and transparent pricing to professional
web development
</p>
</div>
{/* Leadership Team */}
...
Licensed Business Owner</Badge>
<p className="text-muted-foreground mb-6">
U.S. Army veteran who created WNP's hour-based pricing model to bring complete
transparency to web development.
Joshua focuses on business strategy, client relations, and ensuring every project
meets military standards of excellence.
</p>
<div className="space-y-2">
...
<Card className="p-8 text-center">
<div className="w-24 h-24 bg-secondary/10 rounded-full flex items-center
...
<p className="text-muted-foreground mb-6">
U.S. Army veteran specializing in modern web development and user experience
design. Anthony leads all technical
development and ensures every project is built with military precision and attention to
detail.
</p>
<div className="space-y-2">
<div className="flex justify-between items-center">
...
WNP Web Development Brokerage, LLC provides transparent, hour-based web
development and UX/UI design services

with military precision. As a veteran-owned business, we focus on quality over
quantity, ensuring every client
...
<p className="text-muted-foreground mb-4">
Professional website development with hour-based pricing and complete
transparency.
...
<p className="text-muted-foreground mb-4">
Unlike fixed-price projects that hide costs and create conflicts, our $85/hour rate with
detailed
...
<p className="text-muted-foreground">
Hour-based pricing, detailed timesheets, and honest communication about what we
can deliver.
</p>
</Card>
<Card className="text-center p-6">
...
<p className="text-muted-foreground">
Military training taught us to be accountable for our work and commitments to our
clients.
</p>
</Card>
<Card className="text-center p-6">
...
Dedicated to serving our clients with the same commitment we showed in military
service.
</p>
</Card>
</div>
...
<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
Advantages of working with a veteran-owned business focused on transparency and
quality
</p>
</div>
<div className="grid md:grid-cols-2 gap-8">
...
<div className="text-sm text-muted-foreground">Work directly with experienced
veteran professionals</div>
</div>
</li>
<li className="flex items-start gap-3">
...
<div className="text-sm text-muted-foreground">Focused approach ensuring
quality for each client</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-accent mt-1">✓</span>
<div>
<div className="font-medium">Transparent Pricing</div>
<div className="text-sm text-muted-foreground">Hour-based contracts with
detailed timesheet documentation</div>
...
<div className="text-sm text-muted-foreground">Punctuality, accountability, and
commitment to deadlines</div>
</div>
</li>
</ul>
</div>
...
<div className="text-sm text-muted-foreground">No surprise fees or scope
creep charges</div>
</div>
</li>
<li className="flex items-start gap-3">
...
<div className="text-sm text-muted-foreground">Direct communication with the
people doing the work</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-red-500 mt-1">✗</span>
...
<div className="text-sm text-muted-foreground">Clear, direct communication
with veteran professionals</div>
</div>
</li>
<li className="flex items-start gap-3">
<span className="text-red-500 mt-1">✗</span>
...
<div className="text-sm text-muted-foreground">Quality-focused approach over
quantity</div>
</div>
</li>
</ul>
...
<div className="bg-gradient-to-br from-primary via-primary/90 to-secondary text-white
rounded-lg p-8 md:p-12">
<h2 className="text-3xl font-bold mb-6">Ready to Work with Veterans Who
Deliver?</h2>
<p className="text-xl mb-8 max-w-2xl mx-auto">
Experience transparent pricing, military reliability, and personal attention from a
dedicated veteran-owned business.
</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">
<Button size="lg" variant="secondary" asChild>
...
try {
const response = await fetch('https://formspree.io/f/xankdoay', {
method: 'POST',
...
<p className="text-sm text-muted-foreground mb-2">Professional design
consultation</p>
...
{/* Success/Error Messages herererereere*/}
...
Thank you! Your message has been sent successfully. We'll get back to you within
24 hours.
</p>
</div>
</div>
...
<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1
1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0
...
<option value="UX/UI Design Consultation ($255)">UX/UI Design Consultation
($255)</option>
<option value="Web Development (Hour-Based)">Web Development
(Hour-Based)</option>
<option value="Cloud Hosting & Monthly Maintenance">Cloud Hosting & Monthly
Maintenance</option>
...
rows={4}
required
placeholder="Tell us about your project goals, specific requirements, current website
(if any), target audience, and any other relevant details..."
className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
focus:outline-none focus:ring-primary focus:border-primary"
></textarea>
</div>
...
<option value="Referral from friend/colleague">Referral from
...
<p>Email: <a href="mailto:dankadouken2222@gmail.com" className="text-primary
hover:underline">dankadouken2222@gmail.com</a></p>
<p>Phone: <a href="tel:254-350-9369" className="text-primary
hover:underline">254-350-9369</a></p>
</div>
</form>
</div>
<div className="space-y-8">
...
<a href="mailto:dankadouken2222@gmail.com"
className="hover:underline">dankadouken2222@gmail.com</a>
</div>
<div className="flex items-center space-x-3">
...
<div className="text-sm text-muted-foreground">Military discipline and
accountability in every project</div>
</div>
</div>
<div className="flex items-start space-x-3">
...
<div className="text-sm text-muted-foreground">Focused approach ensuring
excellence for each client</div>
</div>
</div>
</div>
</div>
...
We respond to all inquiries within 24 hours during business days. For urgent requests,
call us directly.
</p>
<div className="text-xs text-muted-foreground">
